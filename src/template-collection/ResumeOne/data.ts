  ...
  workExperience: [
    {
      ...
      projects: [
        ...
        },
        {
          ...
          projectName: "Microsoft Teams Developer Portal",
          ...
          activities: [
            ...
            {
              activityId: "c5a49078-e815-4db4-b715-c2de5700f9c9",
            ...
            {
              activityId: "44f01b9b-2d1e-4a57-b7c9-a224d44429fd",
            ...
            {
              activityId: "99908331-fe98-41b3-bade-3d46752f11ad",
              activityDescription: "Involved in building new CI/CD pipelines for the front-end client app",
              keywords: []
            },
            {
              activityId: "f4763abd-0907-4c7e-b2b6-997467515a37",
            ...
            {
              activityId: "2d00f2c1-ab15-47c8-affc-8eccedb2a745",
    ...
    },
    {
      ...
      projects: [
        {
          projectId: "332350ae-0036-46eb-a3dc-f8af1cdad338",
          projectName: "Concierge Web Application",
          role: "Software Engineer",
          fromDate: "August 2019",
          toDate: "February 2020",
          company: { companyId: "", name: "" },
          clientName: "Enterprise Apps (Internal)",
          activities: [
            {
              activityId: "8804a2bc-35e0-48e5-8966-bec525162e6d",
              activityDescription: "Responsible for transforming design mockups to W3C standards compliant HTML pages using CSS, JavaScript, Bootstrap.",
              keywords: []
            },
            {
              activityId: "ac793d1d-46e1-45a7-9668-122497e92397",
              activityDescription: "Involved in the development of a web application using ASP.NET and C#.NET.",
              keywords: []
            },
            {
              activityId: "72995f7b-b38b-484f-8cf0-3ab1ee333817",
            ...
            {
              activityId: "ec5123e0-e11c-4de9-9376-3c2486b1ecc8",
              activityDescription: "Used ReactJS in the development of the web applications.",
              keywords: []
            },
            {
              activityId: "3321b542-e4d9-4608-b51f-8e029dbdeab6",
              activityDescription: "Built components using JSX in ReactJS for rich user interface view, used webpack built tool and Babel-Loader for trans piling and bundling JSX.",
              keywords: []
            },
            {
              activityId: "10b753fc-8f11-470e-a071-5c776e0ffbff",
              activityDescription: "Used React router for Routing/Navigation of views.",
              keywords: []
            },
            {
              activityId: "7b6e2203-0026-48b5-8c56-6f656c1bd125",
              activityDescription: "Used Redux for state management, to store the whole state of the app in an immutable object tree.",
              keywords: []
            },
            {
              activityId: "4dc1bf9c-0859-4acc-80ad-bccc4e3a237c",
              activityDescription: "Used React-redux(connect) which is responsible to “map state to props” and “map dispatch to props”.",
              keywords: []
            },
            {
              activityId: "cb3aa4b0-8397-43f2-b988-f8dc7d984954",
              activityDescription: "Used request to make async calls from the Rest API.",
              keywords: []
            },
            {
              activityId: "834525ef-0915-4eec-a3c8-669144fff6a2",
              activityDescription: "Used React-Autocomplete for creating google maps location search on the webpage.",
              keywords: []
            },
            {
              activityId: "d6235ee7-bc6b-4c4b-9d39-f5ecb6f3c068",
              activityDescription: "Implemented ReactJS code to handle cross browser compatibility issues in Mozilla, Edge, Chrome and Safari.",
              keywords: []
            },
            {
              activityId: "87127e2c-ac3b-4197-9c78-40b4add5c6d2",
              activityDescription: "Used npm commands for building, bundling and deploying the project.",
              keywords: []
            },
            {
              activityId: "ec31fff0-f5fb-4f7c-919f-bf7743788990",
              activityDescription: "Participated in making Responsive Web Designs using Bootstrap with Media Queries and involved in developing complex drop-down menu which included all the Groupings defined by the organization.",
              keywords: []
            },
            {
              activityId: "c1f2e3d5-ee01-4499-bf26-92c638cbbcee",
              activityDescription: "Involved in designing architecture of restful API’s in the backend to be consumed in front end.",
              keywords: []
            },
            {
              activityId: "274be9f4-5da7-4648-ae9d-c682b8bb5d32",
              activityDescription: "Implemented CI/CD development methodology and used Git for source control",
              keywords: []
            }
          ]
        },
        {
          ...
          activities: [
            ...
            {
              activityId: "b76e5873-98e2-4667-9682-ddb3162935a2",
              activityDescription: "Involved in creating task groups and making its use in different pipelines.",
              keywords: []
            },
            {
              activityId: "11aefe75-0d10-4ec6-9a84-613d9592ab74",
            ...
            {
              activityId: "150603ef-4dde-4af7-9a79-0217ed49b529",
        ...
        },
        {
          ...
          activities: [
            ...
            {
              activityId: "e257f02e-2e9e-4836-8be1-10ca463b29c4",
            ...
            {
              activityId: "4386be09-0711-4782-991d-9fcec9ac5574",
            ...
            {
              activityId: "c49e391d-4b9b-4b42-b2e8-a021854544a3",
            ...
            {
              activityId: "a3b6b610-4c6c-4e53-8770-9a38412fe95a",
            ...
            {
              activityId: "e9073828-c730-45d2-81da-ddaa246f7f25",
            ...
            {
              activityId: "97ee1ed8-508b-4886-b013-fd653e2bce70",
            ...
            {
              activityId: "f10eb0d3-959e-480c-80e2-262ec1d5baf1",
      ...
      projects: [
        {
          ...
          projectName: "Microsoft  Universal Storefronts",
          fromDate: "June 2015",
          toDate: "August 2016",
          ...
          activities: [
            ...
            {
              activityId: "30530e63-ddeb-43e6-b7d0-f94d2d235c73",
              activityDescription: "Involved software development life cycle (SDLC) and multilayered architecture and follows agile methodology.",
              keywords: []
            },
            {
              activityId: "1ecd1a97-54d5-4c3d-a6a8-a0d5b3b40b9e",
              activityDescription: "Developed functionalities and controls to be implemented in a content management system (CMS).",
              keywords: []
            },
            {
              activityId: "da1d1994-0fc0-4857-b516-64928a011460",
    ...
    {
      wexId: "084380bc-8974-42b4-9bfa-dd3da3386145",
      company: { companyId: "", name: "" },
      role: "",
      startDate: "",
      endDate: "",
