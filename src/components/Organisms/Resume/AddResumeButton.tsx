...
export const AddResumeButton: FC = () => {
    ...
    return <>
        <Card shadow="sm" p="lg" style={{ maxWidth: 500, width: 200, height: 200, display: 'flex', flexDirection: "column" }}>
            <Link to={"/resume/new"} style={{ textDecoration: "none" }}>

                <Card.Section style={{ justifyContent: "center", alignItems: "center", paddingTop: 35, display: "flex", flex: 3 }}>
                    {/* <Image
          src=""
          height={160}
          alt="Norway"
